...
public class GameState extends State {
	...
	private float initialH1;
	private float initialH2;
	...
	public void crearJugadores() {
		...
		initialH1=handler.getGame().health;
		initialH2=handler.getGame().health2;
	}
	...
	public void tick() {
		world.tick();
		System.out.println(initialH1);
		System.out.println(initialH2);
	...
	public void render(Graphics g) {
		...
		g.drawString("Salud J1:",20,100);
		if(initialH1==10) {
			g.fillRect(20,150,30*(int)player.getHealth(),30);
			g.drawString(""+(int)player.getHealth(),30*(int)player.getHealth()+20,180);
		}
		if(initialH2==10) {
			g.fillRect(880,150,-30*(int)player2.getHealth(),30);
			g.drawString(""+(int)player2.getHealth(),-30*(int)player2.getHealth()+830,180);
			
		}
		if(initialH1==12) {
			g.fillRect(20,150,23*(int)player.getHealth(),30);
		}
		if(initialH2==12) {
			g.fillRect(880,150,-23*(int)player2.getHealth(),30);
			
		}
		if(initialH1==15) {
			g.fillRect(20,150,17*(int)player.getHealth(),30);
		}
		if(initialH2==15) {
			g.fillRect(880,150,-17*(int)player2.getHealth(),30);
			
		}
		
		g.drawString("Salud J2:" ,650,100);

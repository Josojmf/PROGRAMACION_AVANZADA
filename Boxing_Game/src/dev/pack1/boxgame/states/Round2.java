...
public class Round2 extends State {
	...
	public void tick() {
		...
		if((!player.checkAlive() || !player2.checkAlive())&&handler.getGame().creaJugadores) {
			...
			timer++;
			if(timer>70) {
				round3=new Round3(handler);
				State.setState(round3);
			}
	...
	public void render(Graphics g) {
		...
		Text.drawString(g, "Round 2",450, 100,true, Color.BLUE,Assets.font75);
